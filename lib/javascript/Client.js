...
function atomic_regulons(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.compute_atomic_regulons = function (workspace, expression_matrix_ref, genome_ref, expression_cutoff, output_atomicRegulons, _callback, _errorCallback) {
        ...
        return json_call_ajax("atomic_regulons.compute_atomic_regulons",
            [workspace, expression_matrix_ref, genome_ref, expression_cutoff, output_atomicRegulons], 1, _callback, _errorCallback);
    };

...
class atomic_regulons(object):
    ...
    def compute_atomic_regulons(self, workspace_name, expression_matrix_ref, genome_ref, json_rpc_context = None):
        ...
        resp = self._call('atomic_regulons.compute_atomic_regulons',
                          [workspace_name, expression_matrix_ref, genome_ref], json_rpc_context)
        return resp[0]
